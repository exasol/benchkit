# Exasol vs ClickHouse Performance Comparison on TPC-H SF30 - Initial Performance Assessment
...
**Key Finding:** Clickhouse demonstrated 9.7× slower median query performance compared to Exasol, highlighting significant optimization opportunities.
