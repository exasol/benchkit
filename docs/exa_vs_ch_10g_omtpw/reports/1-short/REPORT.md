...
Exasol achieved a median query runtime of **66.5ms** across all TPC-H queries, establishing a competitive performance baseline for analytical workload processing.
...
|--------|--------------------|------------|------------|
| Median Runtime | 546.6ms | 66.5ms | 8.2× slower |
| Average Runtime | 848.7ms | 85.1ms | 10.0× slower |
| Fastest Query | 53.4ms | 11.9ms | 4.5× slower |
| Slowest Query | 6326.3ms | 246.3ms | 25.7× slower |
...
- **Q21**: Clickhouse 6236.6ms vs Exasol 99.6ms (62.6× slower)
- **Q17**: Clickhouse 743.8ms vs Exasol 14.0ms (53.1× slower)
- **Q08**: Clickhouse 1623.9ms vs Exasol 32.5ms (50.0× slower)

**Queries with Competitive Performance:**

- **Q16**: Clickhouse 192.3ms vs Exasol 229.8ms (0.8× slower)
- **Q15**: Clickhouse 94.0ms vs Exasol 78.5ms (1.2× slower)
