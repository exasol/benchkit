...
**Key Finding:** Clickhouse demonstrated 8.1× slower median query performance compared to Exasol, highlighting significant optimization opportunities.

## The Baseline: Exasol

Exasol achieved a median query runtime of **66.0ms** across all TPC-H queries, establishing a competitive performance baseline for analytical workload processing.
...
|--------|--------------------|------------|------------|
| Median Runtime | 535.0ms | 66.0ms | 8.1× slower |
| Average Runtime | 919.6ms | 84.5ms | 10.9× slower |
| Fastest Query | 54.3ms | 12.5ms | 4.3× slower |
| Slowest Query | 6506.2ms | 242.9ms | 26.8× slower |
...
- **Q17**: Clickhouse 1896.7ms vs Exasol 14.9ms (127.3× slower)
- **Q21**: Clickhouse 6426.0ms vs Exasol 103.5ms (62.1× slower)
- **Q08**: Clickhouse 1607.9ms vs Exasol 32.2ms (49.9× slower)

**Queries with Competitive Performance:**

- **Q16**: Clickhouse 193.8ms vs Exasol 230.7ms (0.8× slower)
- **Q15**: Clickhouse 94.4ms vs Exasol 79.9ms (1.2× slower)
