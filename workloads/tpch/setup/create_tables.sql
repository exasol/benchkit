...
-- Data is read directly from Parquet files generated by tpchgen-cli - zero copy loading
-- External location: {{ hive_warehouse }}/{{ schema }}/
{% else %}
...
WITH (
    format = 'PARQUET',
    external_location = 'file://{{ hive_warehouse }}/{{ schema }}/nation'
);
{% endif %}
...
WITH (
    format = 'PARQUET',
    external_location = 'file://{{ hive_warehouse }}/{{ schema }}/region'
);
{% endif %}
...
WITH (
    format = 'PARQUET',
    external_location = 'file://{{ hive_warehouse }}/{{ schema }}/part'
);
{% endif %}
...
WITH (
    format = 'PARQUET',
    external_location = 'file://{{ hive_warehouse }}/{{ schema }}/supplier'
);
{% endif %}
...
WITH (
    format = 'PARQUET',
    external_location = 'file://{{ hive_warehouse }}/{{ schema }}/partsupp'
);
{% endif %}
...
WITH (
    format = 'PARQUET',
    external_location = 'file://{{ hive_warehouse }}/{{ schema }}/customer'
);
{% endif %}
...
WITH (
    format = 'PARQUET',
    external_location = 'file://{{ hive_warehouse }}/{{ schema }}/orders'
);
{% endif %}
...
WITH (
    format = 'PARQUET',
    external_location = 'file://{{ hive_warehouse }}/{{ schema }}/lineitem'
);
{% endif %}
