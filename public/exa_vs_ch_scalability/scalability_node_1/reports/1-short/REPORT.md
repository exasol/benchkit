# Node Scaling - 1 Node (32GB) - Initial Performance Assessment
...
**Key Finding:** Clickhouse demonstrated 8.2× slower median query performance compared to Exasol, highlighting significant optimization opportunities.

## The Baseline: Exasol

Exasol achieved a median query runtime of **1520.7ms** across all TPC-H queries, establishing a competitive performance baseline for analytical workload processing.
...
|--------|--------------------|------------|------------|
| Median Runtime | 12507.9ms | 1520.7ms | 8.2× slower |
| Average Runtime | 13450.8ms | 2970.6ms | 4.5× slower |
| Fastest Query | 966.2ms | 85.4ms | 11.3× slower |
| Slowest Query | 45535.4ms | 19497.1ms | 2.3× slower |
...
- **Q17**: Clickhouse 12737.2ms vs Exasol 112.6ms (113.1× slower)
- **Q19**: Clickhouse 42695.6ms vs Exasol 394.8ms (108.1× slower)
- **Q04**: Clickhouse 23112.0ms vs Exasol 638.0ms (36.2× slower)

**Queries with Competitive Performance:**

- **Q09**: Clickhouse 12932.6ms vs Exasol 12093.8ms (1.1× slower)
- **Q21**: Clickhouse 11051.5ms vs Exasol 5745.1ms (1.9× slower)
