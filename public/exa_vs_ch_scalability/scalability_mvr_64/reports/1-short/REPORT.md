# Minimum Viable Resources - 64GB - Initial Performance Assessment
...
**Key Finding:** Clickhouse demonstrated 13.7× slower median query performance compared to Exasol, highlighting significant optimization opportunities.

## The Baseline: Exasol

Exasol achieved a median query runtime of **861.0ms** across all TPC-H queries, establishing a competitive performance baseline for analytical workload processing.
...
|--------|--------------------|------------|------------|
| Median Runtime | 11791.7ms | 861.0ms | 13.7× slower |
| Average Runtime | 11686.0ms | 1317.8ms | 8.9× slower |
| Fastest Query | 581.5ms | 36.1ms | 16.1× slower |
| Slowest Query | 30518.7ms | 6684.4ms | 4.6× slower |
...
- **Q19**: Clickhouse 24494.9ms vs Exasol 171.0ms (143.2× slower)
- **Q17**: Clickhouse 8588.7ms vs Exasol 68.3ms (125.7× slower)
- **Q02**: Clickhouse 10485.6ms vs Exasol 179.9ms (58.3× slower)

**Queries with Competitive Performance:**

- **Q09**: Clickhouse 11944.9ms vs Exasol 5245.7ms (2.3× slower)
- **Q13**: Clickhouse 11800.6ms vs Exasol 3592.1ms (3.3× slower)
