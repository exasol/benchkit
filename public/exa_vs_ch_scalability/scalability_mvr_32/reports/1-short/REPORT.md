# Minimum Viable Resources - 32GB - Initial Performance Assessment
...
**Key Finding:** Clickhouse demonstrated 9.3× slower median query performance compared to Exasol, highlighting significant optimization opportunities.

## The Baseline: Exasol

Exasol achieved a median query runtime of **1239.3ms** across all TPC-H queries, establishing a competitive performance baseline for analytical workload processing.
...
|--------|--------------------|------------|------------|
| Median Runtime | 11504.9ms | 1239.3ms | 9.3× slower |
| Average Runtime | 12328.3ms | 2783.5ms | 4.4× slower |
| Fastest Query | 2246.8ms | 44.6ms | 50.4× slower |
| Slowest Query | 47060.1ms | 23488.5ms | 2.0× slower |
...
- **Q19**: Clickhouse 40416.5ms vs Exasol 365.5ms (110.6× slower)
- **Q17**: Clickhouse 12327.1ms vs Exasol 157.9ms (78.1× slower)
- **Q04**: Clickhouse 20709.8ms vs Exasol 666.0ms (31.1× slower)

**Queries with Competitive Performance:**

- **Q09**: Clickhouse 13917.5ms vs Exasol 12002.0ms (1.2× slower)
- **Q21**: Clickhouse 7869.1ms vs Exasol 5391.0ms (1.5× slower)
