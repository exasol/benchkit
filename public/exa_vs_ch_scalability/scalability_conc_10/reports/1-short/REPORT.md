# Concurrency Cliff - 10 Streams - Initial Performance Assessment
...
**Key Finding:** Clickhouse demonstrated 18.2× slower median query performance compared to Exasol, highlighting significant optimization opportunities.

## The Baseline: Exasol

Exasol achieved a median query runtime of **497.8ms** across all TPC-H queries, establishing a competitive performance baseline for analytical workload processing.
...
|--------|--------------------|------------|------------|
| Median Runtime | 9061.5ms | 497.8ms | 18.2× slower |
| Average Runtime | 10487.6ms | 1114.0ms | 9.4× slower |
| Fastest Query | 1703.7ms | 56.4ms | 30.2× slower |
| Slowest Query | 27651.8ms | 4771.5ms | 5.8× slower |
...
- **Q19**: Clickhouse 18631.5ms vs Exasol 88.2ms (211.2× slower)
- **Q17**: Clickhouse 8595.3ms vs Exasol 95.2ms (90.3× slower)
- **Q04**: Clickhouse 14696.4ms vs Exasol 298.0ms (49.3× slower)

**Queries with Competitive Performance:**

- **Q15**: Clickhouse 2257.4ms vs Exasol 914.9ms (2.5× slower)
- **Q09**: Clickhouse 12982.6ms vs Exasol 4049.4ms (3.2× slower)
