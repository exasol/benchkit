# Concurrency Cliff - 20 Streams - Initial Performance Assessment
...
**Key Finding:** Clickhouse demonstrated 8.6× slower median query performance compared to Exasol, highlighting significant optimization opportunities.

## The Baseline: Exasol

Exasol achieved a median query runtime of **1365.2ms** across all TPC-H queries, establishing a competitive performance baseline for analytical workload processing.
...
|--------|--------------------|------------|------------|
| Median Runtime | 11765.4ms | 1365.2ms | 8.6× slower |
| Average Runtime | 12265.9ms | 2110.8ms | 5.8× slower |
| Fastest Query | 2713.4ms | 84.9ms | 32.0× slower |
| Slowest Query | 36939.5ms | 10604.9ms | 3.5× slower |
...
- **Q19**: Clickhouse 32450.8ms vs Exasol 201.9ms (160.7× slower)
- **Q17**: Clickhouse 13735.1ms vs Exasol 141.3ms (97.2× slower)
- **Q04**: Clickhouse 18851.3ms vs Exasol 578.9ms (32.6× slower)

**Queries with Competitive Performance:**

- **Q09**: Clickhouse 10482.8ms vs Exasol 9948.7ms (1.1× slower)
- **Q15**: Clickhouse 4600.9ms vs Exasol 1728.4ms (2.7× slower)
