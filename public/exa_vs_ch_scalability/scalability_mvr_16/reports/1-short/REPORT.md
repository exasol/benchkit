# Minimum Viable Resources - 16GB - Initial Performance Assessment
...
**Key Finding:** Clickhouse demonstrated 4.9× slower median query performance compared to Exasol, highlighting significant optimization opportunities.

## The Baseline: Exasol

Exasol achieved a median query runtime of **3035.7ms** across all TPC-H queries, establishing a competitive performance baseline for analytical workload processing.
...
|--------|--------------------|------------|------------|
| Median Runtime | 14766.8ms | 3035.7ms | 4.9× slower |
| Average Runtime | 21878.1ms | 6084.0ms | 3.6× slower |
| Fastest Query | 2812.5ms | 109.4ms | 25.7× slower |
| Slowest Query | 122749.8ms | 93092.8ms | 1.3× slower |
...
- **Q19**: Clickhouse 113511.3ms vs Exasol 978.7ms (116.0× slower)
- **Q17**: Clickhouse 27526.2ms vs Exasol 343.1ms (80.2× slower)
- **Q02**: Clickhouse 18452.5ms vs Exasol 530.3ms (34.8× slower)

**Queries with Competitive Performance:**

- **Q09**: Clickhouse 12024.4ms vs Exasol 16913.4ms (0.7× slower)
- **Q21**: Clickhouse 10112.2ms vs Exasol 7895.2ms (1.3× slower)
