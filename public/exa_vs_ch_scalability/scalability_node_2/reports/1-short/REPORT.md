# Node Scaling - 2 Nodes (64GB) - Initial Performance Assessment
...
**Key Finding:** Clickhouse demonstrated 6.9× slower median query performance compared to Exasol, highlighting significant optimization opportunities.

## The Baseline: Exasol

Exasol achieved a median query runtime of **1206.1ms** across all TPC-H queries, establishing a competitive performance baseline for analytical workload processing.
...
|--------|--------------------|------------|------------|
| Median Runtime | 8354.5ms | 1206.1ms | 6.9× slower |
| Average Runtime | 9977.6ms | 2157.8ms | 4.6× slower |
| Fastest Query | 519.3ms | 52.8ms | 9.8× slower |
| Slowest Query | 30280.0ms | 13765.4ms | 2.2× slower |
...
- **Q02**: Clickhouse 29354.3ms vs Exasol 355.2ms (82.6× slower)
- **Q19**: Clickhouse 21943.4ms vs Exasol 379.8ms (57.8× slower)
- **Q17**: Clickhouse 8159.3ms vs Exasol 201.7ms (40.5× slower)

**Queries with Competitive Performance:**

- **Q09**: Clickhouse 7741.0ms vs Exasol 10652.3ms (0.7× slower)
- **Q15**: Clickhouse 1764.8ms vs Exasol 1211.2ms (1.5× slower)
