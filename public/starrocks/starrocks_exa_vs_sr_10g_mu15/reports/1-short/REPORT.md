# Exasol vs StarRocks: TPC-H SF10 (Single-Node, 15 Streams) - Initial Performance Assessment
...
Exasol achieved a median query runtime of **2766.6ms** across all TPC-H queries, establishing a competitive performance baseline for analytical workload processing.
...
|--------|------------------|------------|------------|
| Median Runtime | 8243.0ms | 2766.6ms | 3.0× slower |
| Average Runtime | 17143.8ms | 5895.2ms | 2.9× slower |
| Fastest Query | 418.0ms | 63.3ms | 6.6× slower |
| Slowest Query | 112296.5ms | 24626.5ms | 4.6× slower |
...
- **Q17**: Starrocks 8213.1ms vs Exasol 312.3ms (26.3× slower)
- **Q18**: Starrocks 59770.0ms vs Exasol 5013.8ms (11.9× slower)
- **Q06**: Starrocks 3747.8ms vs Exasol 591.6ms (6.3× slower)

**Queries with Competitive Performance:**

- **Q16**: Starrocks 1031.9ms vs Exasol 12548.4ms (0.1× slower)
- **Q10**: Starrocks 6230.6ms vs Exasol 4905.4ms (1.3× slower)
