# Exasol vs StarRocks: TPC-H SF30 (Multi-Node 3, 5 Streams) - Initial Performance Assessment
...
**Key Finding:** Starrocks demonstrated 3.8× slower median query performance compared to Exasol, highlighting significant optimization opportunities.

## The Baseline: Exasol

Exasol achieved a median query runtime of **2204.8ms** across all TPC-H queries, establishing a competitive performance baseline for analytical workload processing.
...
|--------|------------------|------------|------------|
| Median Runtime | 8312.5ms | 2204.8ms | 3.8× slower |
| Average Runtime | 22181.2ms | 4277.3ms | 5.2× slower |
| Fastest Query | 1252.4ms | 176.0ms | 7.1× slower |
| Slowest Query | 185595.1ms | 28564.3ms | 6.5× slower |
...
- **Q04**: Starrocks 61306.7ms vs Exasol 1181.2ms (51.9× slower)
- **Q17**: Starrocks 5475.8ms vs Exasol 395.8ms (13.8× slower)
- **Q18**: Starrocks 33756.7ms vs Exasol 2586.4ms (13.1× slower)

**Queries with Competitive Performance:**

- **Q07**: Starrocks 7231.0ms vs Exasol 7067.0ms (1.0× slower)
- **Q16**: Starrocks 2572.5ms vs Exasol 2406.4ms (1.1× slower)
