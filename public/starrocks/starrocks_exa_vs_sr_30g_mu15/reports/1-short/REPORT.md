# Exasol vs StarRocks: TPC-H SF30 (Single-Node, 15 Streams) - Initial Performance Assessment
...
**Key Finding:** Starrocks demonstrated 1.8× slower median query performance compared to Exasol, highlighting significant optimization opportunities.

## The Baseline: Exasol

Exasol achieved a median query runtime of **4532.4ms** across all TPC-H queries, establishing a competitive performance baseline for analytical workload processing.
...
|--------|------------------|------------|------------|
| Median Runtime | 8237.7ms | 4532.4ms | 1.8× slower |
| Average Runtime | 26393.4ms | 10328.4ms | 2.6× slower |
| Fastest Query | 551.0ms | 85.1ms | 6.5× slower |
| Slowest Query | 249315.6ms | 90350.8ms | 2.8× slower |
...
- **Q17**: Starrocks 1984.8ms vs Exasol 364.5ms (5.4× slower)
- **Q01**: Starrocks 109887.2ms vs Exasol 20282.5ms (5.4× slower)
- **Q21**: Starrocks 59616.1ms vs Exasol 19181.3ms (3.1× slower)

**Queries with Competitive Performance:**

- **Q16**: Starrocks 1315.5ms vs Exasol 11545.6ms (0.1× slower)
- **Q22**: Starrocks 1893.1ms vs Exasol 2831.0ms (0.7× slower)
