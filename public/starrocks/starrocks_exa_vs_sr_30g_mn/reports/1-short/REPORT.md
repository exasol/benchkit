# Exasol vs StarRocks: TPC-H SF30 (Multi-Node 3, Single-User) - Initial Performance Assessment
...
**Key Finding:** Starrocks demonstrated 9.1× slower median query performance compared to Exasol, highlighting significant optimization opportunities.

## The Baseline: Exasol

Exasol achieved a median query runtime of **433.3ms** across all TPC-H queries, establishing a competitive performance baseline for analytical workload processing.
...
|--------|------------------|------------|------------|
| Median Runtime | 3954.8ms | 433.3ms | 9.1× slower |
| Average Runtime | 5531.8ms | 786.4ms | 7.0× slower |
| Fastest Query | 472.2ms | 69.6ms | 6.8× slower |
| Slowest Query | 15873.5ms | 4245.4ms | 3.7× slower |
...
- **Q17**: Starrocks 3159.9ms vs Exasol 82.3ms (38.4× slower)
- **Q06**: Starrocks 2387.9ms vs Exasol 70.1ms (34.1× slower)
- **Q19**: Starrocks 3319.4ms vs Exasol 108.7ms (30.5× slower)

**Queries with Competitive Performance:**

- **Q16**: Starrocks 1257.6ms vs Exasol 566.4ms (2.2× slower)
- **Q11**: Starrocks 614.7ms vs Exasol 265.0ms (2.3× slower)
