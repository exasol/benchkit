# Exasol vs StarRocks: TPC-H SF10 (Multi-Node 3, 5 Streams) - Initial Performance Assessment
...
Exasol achieved a median query runtime of **805.8ms** across all TPC-H queries, establishing a competitive performance baseline for analytical workload processing.
...
|--------|------------------|------------|------------|
| Median Runtime | 2582.1ms | 805.8ms | 3.2× slower |
| Average Runtime | 6395.7ms | 1436.2ms | 4.5× slower |
| Fastest Query | 312.4ms | 33.7ms | 9.3× slower |
| Slowest Query | 99238.1ms | 8210.2ms | 12.1× slower |
...
- **Q21**: Starrocks 25363.2ms vs Exasol 1345.2ms (18.9× slower)
- **Q01**: Starrocks 30394.0ms vs Exasol 2121.0ms (14.3× slower)
- **Q17**: Starrocks 1584.7ms vs Exasol 226.8ms (7.0× slower)

**Queries with Competitive Performance:**

- **Q09**: Starrocks 6900.0ms vs Exasol 5934.6ms (1.2× slower)
- **Q16**: Starrocks 1814.8ms vs Exasol 1377.6ms (1.3× slower)
