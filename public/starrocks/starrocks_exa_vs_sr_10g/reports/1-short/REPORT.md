# Exasol vs StarRocks: TPC-H SF10 (Single-Node, Single-User) - Initial Performance Assessment
...
Exasol achieved a median query runtime of **210.0ms** across all TPC-H queries, establishing a competitive performance baseline for analytical workload processing.
...
|--------|------------------|------------|------------|
| Median Runtime | 956.1ms | 210.0ms | 4.6× slower |
| Average Runtime | 1361.2ms | 364.6ms | 3.7× slower |
| Fastest Query | 193.1ms | 19.0ms | 10.2× slower |
| Slowest Query | 4257.0ms | 1256.4ms | 3.4× slower |
...
- **Q19**: Starrocks 1190.9ms vs Exasol 34.2ms (34.8× slower)
- **Q17**: Starrocks 486.2ms vs Exasol 19.8ms (24.6× slower)
- **Q08**: Starrocks 1629.6ms vs Exasol 107.9ms (15.1× slower)

**Queries with Competitive Performance:**

- **Q16**: Starrocks 448.4ms vs Exasol 438.1ms (1.0× slower)
- **Q13**: Starrocks 1663.7ms vs Exasol 1108.8ms (1.5× slower)
