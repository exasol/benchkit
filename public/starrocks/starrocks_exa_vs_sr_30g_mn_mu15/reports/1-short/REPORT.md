# Exasol vs StarRocks: TPC-H SF30 (Multi-Node 3, 15 Streams) - Initial Performance Assessment
...
**Key Finding:** Starrocks demonstrated 6.3× slower median query performance compared to Exasol, highlighting significant optimization opportunities.

## The Baseline: Exasol

Exasol achieved a median query runtime of **4041.0ms** across all TPC-H queries, establishing a competitive performance baseline for analytical workload processing.
...
|--------|------------------|------------|------------|
| Median Runtime | 25564.4ms | 4041.0ms | 6.3× slower |
| Average Runtime | 56032.0ms | 14093.5ms | 4.0× slower |
| Fastest Query | 1229.9ms | 157.7ms | 7.8× slower |
| Slowest Query | 300119.4ms | 116417.2ms | 2.6× slower |
...
- **Q04**: Starrocks 300032.5ms vs Exasol 2131.4ms (140.8× slower)
- **Q17**: Starrocks 36337.6ms vs Exasol 583.3ms (62.3× slower)
- **Q01**: Starrocks 226414.9ms vs Exasol 6866.8ms (33.0× slower)

**Queries with Competitive Performance:**

- **Q16**: Starrocks 5289.7ms vs Exasol 14140.7ms (0.4× slower)
- **Q09**: Starrocks 39890.6ms vs Exasol 45606.7ms (0.9× slower)
