# Exasol vs StarRocks: TPC-H SF1 (Multi-Node 3, Single-User) - Initial Performance Assessment
...
**Key Finding:** Starrocks demonstrated 1.6× slower median query performance compared to Exasol, highlighting significant optimization opportunities.

## The Baseline: Exasol

Exasol achieved a median query runtime of **82.2ms** across all TPC-H queries, establishing a competitive performance baseline for analytical workload processing.
...
|--------|------------------|------------|------------|
| Median Runtime | 132.3ms | 82.2ms | 1.6× slower |
| Average Runtime | 176.0ms | 95.8ms | 1.8× slower |
| Fastest Query | 46.8ms | 24.9ms | 1.9× slower |
| Slowest Query | 559.9ms | 440.1ms | 1.3× slower |
...
- **Q01**: Starrocks 480.9ms vs Exasol 72.4ms (6.6× slower)
- **Q21**: Starrocks 424.3ms vs Exasol 83.1ms (5.1× slower)
- **Q13**: Starrocks 179.0ms vs Exasol 77.8ms (2.3× slower)

**Queries with Competitive Performance:**

- **Q18**: Starrocks 225.1ms vs Exasol 226.2ms (1.0× slower)
- **Q20**: Starrocks 113.6ms vs Exasol 94.7ms (1.2× slower)
