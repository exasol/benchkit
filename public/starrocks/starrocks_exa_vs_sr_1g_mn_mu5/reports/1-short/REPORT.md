# Exasol vs StarRocks: TPC-H SF1 (Multi-Node 3, 5 Streams) - Initial Performance Assessment
...
Exasol achieved a median query runtime of **240.0ms** across all TPC-H queries, establishing a competitive performance baseline for analytical workload processing.
...
```bash
# [All 3 Nodes] Format /dev/disk/by-id/nvme-Amazon_EC2_NVMe_Instance_Storage_AWS22A1B73F88DF64962 with ext4 filesystem
sudo mkfs.ext4 -F /dev/disk/by-id/nvme-Amazon_EC2_NVMe_Instance_Storage_AWS22A1B73F88DF64962

# [All 3 Nodes] Create mount point /data
sudo mkdir -p /data

# [All 3 Nodes] Mount /dev/disk/by-id/nvme-Amazon_EC2_NVMe_Instance_Storage_AWS22A1B73F88DF64962 to /data
sudo mount /dev/disk/by-id/nvme-Amazon_EC2_NVMe_Instance_Storage_AWS22A1B73F88DF64962 /data
...
|--------|------------------|------------|------------|
| Median Runtime | 675.2ms | 240.0ms | 2.8× slower |
| Average Runtime | 799.0ms | 305.1ms | 2.6× slower |
| Fastest Query | 119.8ms | 18.4ms | 6.5× slower |
| Slowest Query | 2792.7ms | 2342.5ms | 1.2× slower |
...
- **Q21**: Starrocks 1903.0ms vs Exasol 240.3ms (7.9× slower)
- **Q01**: Starrocks 932.3ms vs Exasol 179.3ms (5.2× slower)
- **Q06**: Starrocks 255.4ms vs Exasol 52.3ms (4.9× slower)

**Queries with Competitive Performance:**

- **Q09**: Starrocks 785.4ms vs Exasol 635.0ms (1.2× slower)
- **Q13**: Starrocks 575.5ms vs Exasol 340.2ms (1.7× slower)
