# Exasol vs StarRocks: TPC-H SF1 (Multi-Node 3, 15 Streams) - Initial Performance Assessment
...
**Key Finding:** Starrocks demonstrated 2.5× slower median query performance compared to Exasol, highlighting significant optimization opportunities.

## The Baseline: Exasol

Exasol achieved a median query runtime of **724.2ms** across all TPC-H queries, establishing a competitive performance baseline for analytical workload processing.
...
|--------|------------------|------------|------------|
| Median Runtime | 1807.4ms | 724.2ms | 2.5× slower |
| Average Runtime | 2032.7ms | 1023.2ms | 2.0× slower |
| Fastest Query | 116.4ms | 27.2ms | 4.3× slower |
| Slowest Query | 8088.4ms | 11690.1ms | 0.7× slower |
...
- **Q11**: Starrocks 2360.0ms vs Exasol 398.2ms (5.9× slower)
- **Q12**: Starrocks 2086.9ms vs Exasol 390.7ms (5.3× slower)
- **Q21**: Starrocks 4765.1ms vs Exasol 1016.6ms (4.7× slower)

**Queries with Competitive Performance:**

- **Q09**: Starrocks 2427.9ms vs Exasol 2682.1ms (0.9× slower)
- **Q16**: Starrocks 1499.2ms vs Exasol 1295.1ms (1.2× slower)
