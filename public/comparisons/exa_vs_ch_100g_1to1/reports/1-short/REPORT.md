...
**Key Finding:** Clickhouse demonstrated 10.7× slower median query performance compared to Exasol, highlighting significant optimization opportunities.

## The Baseline: Exasol

Exasol achieved a median query runtime of **238.1ms** across all TPC-H queries, establishing a competitive performance baseline for analytical workload processing.

## Clickhouse 25.9.5.21 - System Under Test
...
|--------|--------------------|------------|------------|
| Median Runtime | 2546.6ms | 238.1ms | 10.7× slower |
| Average Runtime | 5378.4ms | 301.1ms | 17.9× slower |
| Fastest Query | 162.6ms | 25.2ms | 6.5× slower |
| Slowest Query | 47984.7ms | 946.5ms | 50.7× slower |
...
- **Q17**: Clickhouse 5821.7ms vs Exasol 28.0ms (207.9× slower)
- **Q21**: Clickhouse 46707.2ms vs Exasol 384.5ms (121.5× slower)
- **Q08**: Clickhouse 7908.5ms vs Exasol 73.7ms (107.3× slower)

**Queries with Competitive Performance:**

- **Q15**: Clickhouse 346.4ms vs Exasol 379.6ms (0.9× slower)
- **Q16**: Clickhouse 517.5ms vs Exasol 457.7ms (1.1× slower)
